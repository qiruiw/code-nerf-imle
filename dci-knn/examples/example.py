...
def main(*args):
    ...
    dci_db.add(data, num_levels=num_levels, field_of_view=construction_field_of_view,
    ...
    #                                   queries. 
    nearest_neighbour_idx, nearest_neighbour_dists = dci_db.query(query, num_neighbours=num_neighbours,
